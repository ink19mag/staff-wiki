...
_Ink 19_ sets itself apart by publishing out of the ordinary reviews, interviews, articles, and features on an unlimited range of subjects. Every section below welcomes self-initiated work — pick something from [Opportunities](https://staff.ink19.com/opportunities/) or tell the editors what you'd like to cover and they'll add it. Here are a few guidelines to help contributors learn the ropes.
