...
- Resolution does not need to be print-quality for screen viewing. Try reducing resolution or adjusting compression to get each image below 200K. JPGs are generally smaller than PNGs.
...
- Add Credit and Caption as appropriate.
